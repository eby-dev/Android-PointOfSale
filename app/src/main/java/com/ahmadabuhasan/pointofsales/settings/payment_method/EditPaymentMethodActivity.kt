...
class EditPaymentMethodActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setTitle(R.string.update_payment_method)

        val payment_method_id = intent.extras!!.getString(Constant.PAYMENT_METHOD_ID)

        binding.etPaymentMethodName.setText(intent.extras!!.getString(Constant.PAYMENT_METHOD_NAME))
        ...
        binding.tvEditPaymentMethod.setOnClickListener {
            ...
            binding.etPaymentMethodName.setTextColor(SupportMenu.CATEGORY_MASK)
